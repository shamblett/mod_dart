...
thisbut there's no real point. Unlike a normal server side VM application that's built to stay alive your mod_dart
...
wrong VM perms, wrong cache perms, invaid paths etc. At the moment you need to find the failure string in the mod_dart code
...
```
Use the'show source' command of your browser to see this. Just fix as normal.
